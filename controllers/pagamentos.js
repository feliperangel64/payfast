...
module.exports = function (app) {
  ...
  app.get('/pagamentos/pagamento/:id', function (req, res) {
    ...
    var clientMemcached = new app.servicos.memcachedClient();
    clientMemcached.get('pagamento-' + id, function (err, retorno) {
      if (err || !retorno) {
  ...
  app.post('/pagamentos/pagamento', function (req, res) {
    ...
    pagamentoDao.salva(pagamento, function (erro, resultado) {
      if (erro) {
        ...
        var clientMemcached = new app.servicos.memcachedClient();
        clientMemcached.set('pagamento-' + pagamento.id, pagamento, 60000, function (err) {
          if (err) {
            console.log(err);
          }
